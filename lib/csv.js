...
export function csv({cluster, reverse, filters: availableFilters}) {
  return async (req, res) => {
    ...
    // Build filters object from config filters and req.body
    const filters = {}
    for (const [filterName] of Object.entries(availableFilters)) {
